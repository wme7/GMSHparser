...
inline constexpr MeshExpectation kV2Expectations[] = {
    ...
    {"extruded_prism_v2.msh", 2.2, 2565, 3, 0, 0, 1888, 320, 0, 0, 3776},
    {"extruded_hex_v2.msh", 2.2, 2205, 3, 0, 0, 0, 1120, 0, 1600, 0},
    {"extruded_mixed_v2.msh", 2.2, 2415, 3, 0, 0, 968, 880, 0, 800, 1936},
    {"rectangle_v2.msh", 2.2, 92, 2, 0, 32, 150, 0, 0, 0, 0},
    {"box_v2.msh", 2.2, 121, 3, 0, 0, 220, 0, 328, 0, 0},
};
...
inline constexpr MeshExpectation kV4Expectations[] = {
    ...
    {"extruded_prism_v4.msh", 4.1, 2565, 3, 0, 0, 1888, 320, 0, 0, 3776},
    {"extruded_hex_v4.msh", 4.1, 2205, 3, 0, 0, 0, 1120, 0, 1600, 0},
    {"extruded_mixed_v4.msh", 4.1, 2415, 3, 0, 0, 968, 800, 0, 800, 1936},
    {"rectangle_v4.msh", 4.1, 92, 2, 0, 32, 150, 0, 0, 0, 0},
    {"box_v4.msh", 4.1, 121, 3, 0, 0, 220, 0, 328, 0, 0},
};
